...
export type NodeType = 
  // Inputs
  | 'SWITCH' | 'BUTTON' | 'CLOCK' | 'HIGH' | 'LOW'
  // Outputs
  | 'LIGHT' | 'LED_RED' | 'LED_GREEN' | 'LED_BLUE' | 'SEVEN_SEG'
  // Logic
...
export interface CircuitNode {
  ...
  memory?: boolean[]; // For RAM/ROM components
...
export interface LogicGateConfig {
  ...
  category: 'Input' | 'Logic' | 'Output' | 'Memory' | 'Discrete' | 'Tools' | 'IC';
}
